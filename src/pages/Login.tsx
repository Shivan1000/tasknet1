...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-6 selection:bg-blue-600 selection:text-white animate-in fade-in slide-in-from-bottom-4 duration-300">
      {/* Custom Alert Toast */}
